 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Borrowing> $managedBorrowings
 * 
 * @method static \Illuminate\Database\Eloquent\Builder|User administrators()
 * @method static \Illuminate\Database\Eloquent\Builder|User librarians()
...
class User extends Authenticatable
{
    ...
    /**
     * Get the borrowings managed by this librarian.
     */
    public function managedBorrowings(): HasMany
    {
    ...
    /**
     * Scope a query to only include librarians.
     *
     * @param  \Illuminate\Database\Eloquent\Builder  $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
